...
export default {
    ...
    karaoke: {
        ...
        noActivePlayer: "কোন সক্রিয় প্লেয়ার পাওয়া যায়নি",
        sessionAlreadyActive: "এই সার্ভারে ইতিমধ্যে একটি সক্রিয় ক্যারাওকে সেশন আছে। এটি শেষ হওয়া পর্যন্ত অপেক্ষা করুন বা বর্তমান সেশন বন্ধ করতে কমান্ডটি আবার ব্যবহার করুন।",
