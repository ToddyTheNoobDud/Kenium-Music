...
export const handlePlaylistAutocomplete = async (interaction, playlistsCollection) => {
...
export const handleTrackIndexAutocomplete = async (interaction, playlistsCollection) => {
